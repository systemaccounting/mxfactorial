...
**a.** no. but while sending someone down the well with a spartan kick to the chest is tempting when you hear them claim it's their "democratic right" to choose when they can stop stealing from you through a "money multiplier", they're likely still under the spell that the counted opinion has more authority than the empirical one  
