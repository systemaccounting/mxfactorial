...
import (
	...
	"github.com/systemaccounting/mxfactorial/services/req-query-trans-id-faas/pkg/mock"
	"github.com/systemaccounting/mxfactorial/services/req-query-trans-id-faas/pkg/util"
)
...
func TestLambdaFn(t *testing.T) {
	...
	tstDB.EXPECT().
		Query(tstCTX, query, tstEvent.TransactionID).
		Return(tstRows, nil).
		Times(1)
