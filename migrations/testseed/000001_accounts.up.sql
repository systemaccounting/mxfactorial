...
-- account profiles
insert into account_profile (account_name, description, first_name, middle_name, last_name, country_name, street_number, street_name, floor_number, unit_number, city_name, county_name, region_name, state_name, postal_code, latlng, email_address, telephone_country_code, telephone_area_code, telephone_number, occupation_id, industry_id) values ('JoeCarter', 'inventor', 'Joe', 'Wilson', 'Carter', 'United States of America', '1050', 'W Olive Ave', null, null, 'Merced', 'Merced County', null, 'California', '95348', '(37.318830, -120.486230)', 'joe@address.xz', 1, 209, 5555555, 1, 1);
...
insert into account_profile (account_name, description, first_name, middle_name, last_name, country_name, street_number, street_name, floor_number, unit_number, city_name, county_name, region_name, state_name, postal_code, latlng, email_address, telephone_country_code, telephone_area_code, telephone_number, occupation_id, industry_id) values ('GroceryCo', 'Grocery store', null, null, null, 'United States of America', '3936', 'Chestnut St', null, null, 'Riverside', 'Riverside County', null, 'California', '92501', '(33.9817585,-117.3774828)', 'groceryco@address.xz', 1, 951, 5555555, null, 8);
