...
milk as (
	insert into transaction_item (transaction_id, rule_instance_id, item_id, price, quantity, debitor, creditor, debitor_profile_id, creditor_profile_id, debitor_approval_time, creditor_approval_time) values ((select id from insert_transaction), null, 'milk', 2.000, 1, 'JacobWebb', 'GroceryCo', (select id from account_profile where account_name = 'JacobWebb'), (select id from account_profile where account_name = 'GroceryCo'), null, NOW()) returning id
),
tax_milk as (
	insert into transaction_item (transaction_id, rule_instance_id, item_id, price, quantity, debitor, creditor, debitor_profile_id, creditor_profile_id, debitor_approval_time, creditor_approval_time) values ((select id from insert_transaction), (select id from item_tax_rule_instance), '9% state sales tax', 0.180, 1, 'JacobWebb', 'StateOfCalifornia', (select id from account_profile where account_name = 'JacobWebb'), (select id from account_profile where account_name = 'StateOfCalifornia'), null, NOW()) returning id
),
bread as (
	insert into transaction_item (transaction_id, rule_instance_id, item_id, price, quantity, debitor, creditor, debitor_profile_id, creditor_profile_id, debitor_approval_time, creditor_approval_time) values ((select id from insert_transaction), null, 'bread', 2.000, 2, 'JacobWebb', 'GroceryCo', (select id from account_profile where account_name = 'JacobWebb'), (select id from account_profile where account_name = 'GroceryCo'), null, NOW()) returning id
),
tax_bread as (
	insert into transaction_item (transaction_id, rule_instance_id, item_id, price, quantity, debitor, creditor, debitor_profile_id, creditor_profile_id, debitor_approval_time, creditor_approval_time) values ((select id from insert_transaction), (select id from item_tax_rule_instance), '9% state sales tax', 0.180, 2, 'JacobWebb', 'StateOfCalifornia', (select id from account_profile where account_name = 'JacobWebb'), (select id from account_profile where account_name = 'StateOfCalifornia'), null, NOW()) returning id
),
eggs as (
	insert into transaction_item (transaction_id, rule_instance_id, item_id, price, quantity, debitor, creditor, debitor_profile_id, creditor_profile_id, debitor_approval_time, creditor_approval_time) values ((select id from insert_transaction), null, 'eggs', 3.000, 1, 'JacobWebb', 'GroceryCo', (select id from account_profile where account_name = 'JacobWebb'), (select id from account_profile where account_name = 'GroceryCo'), null, NOW()) returning id
),
tax_eggs as (
	insert into transaction_item (transaction_id, rule_instance_id, item_id, price, quantity, debitor, creditor, debitor_profile_id, creditor_profile_id, debitor_approval_time, creditor_approval_time) values ((select id from insert_transaction), (select id from item_tax_rule_instance), '9% state sales tax', 0.270, 1, 'JacobWebb', 'StateOfCalifornia', (select id from account_profile where account_name = 'JacobWebb'), (select id from account_profile where account_name = 'StateOfCalifornia'), null, NOW()) returning id
),
