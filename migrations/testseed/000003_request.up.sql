...
appr_igor_debitor_rule_instance as (
	SELECT * FROM approval_rule_instance WHERE rule_instance_name='ApproveDebitStateOfCalifornia' AND account_name = 'IgorPetrov'
),
appr_miriam_debitor_rule_instance as (
	SELECT * FROM approval_rule_instance WHERE rule_instance_name='ApproveDebitStateOfCalifornia' AND account_name = 'MiriamLevy'
),
appr_ben_creditor_rule_instance as (
	SELECT * FROM approval_rule_instance WHERE rule_instance_name='ApproveAllCaliforniaCredit' AND account_name = 'BenRoss'
),
appr_jacob_creditor_rule_instance as (
	SELECT * FROM approval_rule_instance WHERE rule_instance_name='ApproveAllCaliforniaCredit' AND account_name = 'DanLee'
),
appr_miriam_creditor_rule_instance as (
	SELECT * FROM approval_rule_instance WHERE rule_instance_name='ApproveAllCaliforniaCredit' AND account_name = 'MiriamLevy'
)
