...
resource "aws_lambda_function" "cognito_account_auto_confirm" {
  filename         = "../../modules/environment/common-bin/cognito/auto-confirm/auto-confirm-src.zip"
  source_code_hash = filesha256("../../modules/environment/common-bin/cognito/auto-confirm/auto-confirm-src.zip")
...
data "archive_file" "delete_faker_account_lambda_zip" {
  type        = "zip"
  source_dir  = "../../modules/environment/common-bin/cognito/delete-faker-accounts"
  output_path = "../../modules/environment/common-bin/cognito/deleteFakerAccounts.zip"
}
...
resource "aws_lambda_function" "delete_faker_cognito_accounts_lambda" {
  filename         = "../../modules/environment/common-bin/cognito/delete-faker-accounts/delete-faker-src.zip"
  source_code_hash = filesha256("../../modules/environment/common-bin/cognito/delete-faker-accounts/delete-faker-src.zip")
